...
# Recibe el frame donde se va a dibujar la gráfica
...
def actualizarGrafica(frame):
    ...
    if not os.path.exists(RSSI_FILE_A) or not os.path.exists(RSSI_FILE_B):
      print("[WARN]: Alguno de los archivos no existe.")
      return
...
# Función para iniciar la segunda gráfica (sondeo del canal vista general)       
...
# Función para actualizar la segunda gráfica
...
# Dibuja el recuadro de estadísticas del sondeo en el frame dado
