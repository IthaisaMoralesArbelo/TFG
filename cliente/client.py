...
# Fecha: 13/02/2025
# Fichero client.py: Contiene la lógica de conexiones y comandos del cliente
...
# Función que envía paquetes probe request
...
# Encargada de escuchar los paquetes beacons enviados por el servidor
...
# Recoge los paquetes con las mediciones
...
# Controla el tiempo que se dedica al sondeo y llama a la función packet_handler()
...
def main():
  ...
  # Creamos los socket para la interfaz y el servidor
